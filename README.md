...
<head>
    ...
    <script src='//libtl.com/sdk.js' data-zone='11156465' data-sdk='show_11156465'></script>
...
<body>
    <div class="container">
        ...
        <div class="ad-container">
            <center>
                ...
                <script type="text/javascript" src="//www.highperformanceformat.com/29662741/invoke.js"></script>
            </center>
        </div>
        ...
        <div class="page-section active" id="home-page">
            ...
            <div class="ad-container">
                <center>
                    ...
                    <script type="text/javascript" src="//www.highperformanceformat.com/29662739/invoke.js"></script>
                </center>
            </div>
    ...
    <script>
        ...
        const BOT_TOKEN = "8651304469:AAEmY5Dbq9NylAxv1edyyKrF8-N9gfG_cuk"; // আপনার বট টোকেন
        const ADMIN_CHAT_ID = "7448519219"; // আপনার টেলিগ্রাম চ্যাট আইডি
        ...
        function checkAdReady() {
            if (typeof window.show_11156465 !== 'function') {
